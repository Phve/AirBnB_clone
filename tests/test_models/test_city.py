...
Unittest classes:
    TestCityInstantiationModified
    TestCitySaveModified
    TestCityToDictModified
"""
import os
import models
import unittest
...
class TestCityInstantiationModified(unittest.TestCase):
...
class TestCityToDictModified(unittest.TestCase):
